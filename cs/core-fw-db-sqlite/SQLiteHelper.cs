...
namespace core_fw.sqlite
{
    ...
    /// </summary>
    [Obsolete("need refactor, don't use...")]
    public class SQLiteHelper
    {
        ...
        /// CreateFile
        /// </summary>
        /// <param name="strDbFile">db file name</param>
        public static void CreateFile(string strDbFile)
        {
        ...
        /// <returns></returns>
        public static string GetConnectionStr(string DataSourceName)
        {
        ...
        /// CreateConnection
        /// </summary>
        /// <param name="strDbFile">strDbFile</param>
        /// <returns>IDbConnection</returns>
        public static SQLiteConnection CreateConnection(string strDbFile)
        {
            SQLiteConnection conn = new SQLiteConnection(GetConnectionStr(strDbFile));
            return conn;
        }
        ...
        /// CreateCommand
        /// </summary>
        /// <param name="connection">SQLiteConnection connection</param>
        /// <returns>SQLiteCommand</returns>
        public static SQLiteCommand CreateCommand(SQLiteConnection connection)
        {
        ...
        /// <param name="transaction">SQLiteTransaction. Transaction consists of Connection, Transaction,  /// and Command, all of which must be created prior to making this method call. </param>
        /// <param name="commandText">Command text.</param>
        /// <param name="paramList">Sqlite Command parameters.</param>
        /// <returns>DataSet</returns>
        /// <remarks>user must examine Transaction Object and handle transaction.connection .Close, etc.</remarks>
        public static DataSet ExecuteDataSet(SQLiteTransaction transaction, string commandText,
            Dictionary<string, object> paramList)
        ...
        public static IDataReader ExecuteReader(SQLiteConnection conn, string commandText,
            object[] paramList)
        {
        ...
        /// <param name="paramList">object[] array of parameter values</param>
        /// <returns>IDataReader</returns>
        public static IDataReader ExecuteReader(SQLiteCommand cmd, string commandText,
            object[] paramList)
        {
        ...
        /// <param name="cmd">SQLiteCommand Object</param>
        /// <param name="commandText">SQL Statement with optional embedded "@param" style parameters</param>
        /// <param name="paramList">Dictionary<string, object>  array of parameter values</param>
        /// <returns>IDataReader</returns>
        public static IDataReader ExecuteReader(SQLiteCommand cmd, string commandText,
            Dictionary<string, object> paramList)
        {
