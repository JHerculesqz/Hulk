...
namespace core_fw_csharp.src.component.http
{
    public class RestUtilsEx
    {
        ...
        private const string LOG_UPLOADFAT = "core-fw-spring.RestUtilsEx.uploadFat";
        private const string LOG_COMMONHTTPREQUEST = "core-fw-spring.RestUtilsEx.commonHttpRequest";
                                       ...
                                       string fileKeyName = "file", int timeOut = 3600000)
        {
            ...
            {
                SysLogUtils.error4Sys(LOG_UPLOADFAT, ex.Message);
                return "";
            }
            finally
            {
        ...
        private static string _commonHttpRequest(string url, string type, ContentType eContentType, string data = "")
        {
            ...
            {
                SysLogUtils.error4Sys(LOG_COMMONHTTPREQUEST, ex.Message);
