package com.firelord.test.db.es;

import com.firelord.test.db.es.dao.CellMo;
import com.firelord.test.db.es.dao.TBLBook;
import com.firelord.test.db.es.dao.TBLBookRepository;
